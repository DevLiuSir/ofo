...
let ofoWholeColor = UIColor(red:0.98, green:0.89, blue:0.18, alpha:1.00)            // ofo全局黄色
let navigationBarTint = UIColor(red: 64/255, green: 50/255, blue: 17/255, alpha: 1) // 导航栏item颜色
